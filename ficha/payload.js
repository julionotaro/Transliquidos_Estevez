...
var PROMPT_DOCS = [
  ...
  '- numeros: MUY IMPORTANTE. Ademas de "referencia", transcribi en "numeros" TODOS los numeros con pinta de identificador/referencia que veas en la pagina (referencias, ordenes, pedidos, albaranes, guias, docs internos), CADA UNO con la etiqueta impresa que tiene al lado o encima, copiada LITERAL. Formato: [{"etiqueta":"<texto impreso tal cual, ej: CMR/ALBARAN segundo numero, Doc. int:, Referencia en factura:, Guia Remessa Numero, Pedido, Su Referencia>","valor":"<solo el numero>"}]. NO decidas cual es la referencia buena: transcribi todos, incluidos los que creas que son trampa (el 5030..., el pedido de compra 31000..., el albaran interno). El sistema elige cual es la referencia con la regla del cliente. Si un numero no tiene etiqueta clara, describi donde esta ("arriba a la derecha", "bajo el total"). Copia los digitos exactos, sin inventar.',
